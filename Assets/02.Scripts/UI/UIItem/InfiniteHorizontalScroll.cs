...
namespace Framework.UI
{
    ...
    public class InfiniteHorizontalScroll : MonoBehaviour
    {
        ...
        ***********************************************************************/
        #region .
        [SerializeField] private Vector2 centerUISize = new(200f, 200f);  // 중앙 UI의 크기
        [SerializeField] private Vector2 edgeUISize = new(100f, 100f);    // 가장 외곽 UI의 크기
        ...
        ***********************************************************************/
        ...
        private List<RectTransform> _targetList = new(8);
        private List<RectTransform> _imposterList = new(8);
        ...
        ***********************************************************************/
        ...
        public void SetSeqeunce(int targetIdx)
        {
            StartCoroutine(Sequence(targetIdx));
        }

        public UnityAction OnCompleteSeqeunce;
        public IEnumerator Sequence(int roundCount)
        {
            transitionTime = 0.1f;
            for (int i = 0; i < roundCount; i++)
            {
                ...
                transitionTime = scaling * Mathf.Pow(param, i);
            }

            yield return new WaitForSeconds(1f);
            OnCompleteSeqeunce?.Invoke();
        }
        #endregion
    ...
    ***********************************************************************/
    ...
    static class RectTransformExtensionHelper
    {
        ...
        {
            @this.sizeDelta = size;
            @this.anchoredPosition = new Vector2(xPos, -65f);
        }
    }
