...
{
    public class CharacterKiring : Character
    {
        ...
        public override void SetCharacterInfo()
        {
            ...
            basicAttackSpeed = characterData.attackSpeed;
            ...
            SetAttackDamage();
            attackSpeed = basicAttackSpeed + (upgradeIndex - 1) * characterData.powerFactor[1];
