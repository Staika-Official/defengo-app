...
{
    public class CharacterBasicWolf : Character
    {
        private void Start()
        {
        ...
        public override void SetCharacterInfo()
        {
            ...
            particleName = starGradeIndex == 4 ? "ScratchHitCritical" : "ScratchHit";
            ...
            criticalRange = (characterData.criticalRange + (upgradeIndex - 1) * characterData.powerFactor[1]) + (0.01f * GameManager.Instance.buffManager.increaseCriticalRate);
        ...
        public override IEnumerator ActionSequence() //Deprecated
        {
            ...
            for (int i = 0; i < targetCache.Count; i++)
            {
                ...
                SoundKey soundKey = starGradeIndex == 4 ? SoundKey.SF_TRIPLE_HIT : SoundKey.SF_DOUBLE_HIT;
