...
{
    public class CharacterFortis : Character
    {
        private void Start()
        {
        ...
        public override IEnumerator ActionSequence()
        {
            ...
            {
                MissileProjectile projectile = GameManager.Instance.objectPoolManager.GetObject<MissileProjectile>(projectileName);
