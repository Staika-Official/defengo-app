...
{
    public class CharacterPenggo : Character
    {
        private void Start()
        {
        ...
        public override IEnumerator ActionSequence()
        {
            ...
            {
                SnowProjectile projectile = GameManager.Instance.objectPoolManager.GetObject<SnowProjectile>(projectileName);
