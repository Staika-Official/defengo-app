...
public class Reporter : MonoBehaviour
{
    ...
    public void Initialize()
    {
        ...
        clearOnNewSceneContent = new GUIContent(
            "",
            images.clearOnNewSceneImage,
            "Clear logs on new scene loaded"
        );
        ...
        clearOnNewSceneLoaded =
            (PlayerPrefs.GetInt("Reporter_clearOnNewSceneLoaded") == 1) ? true : false;
    ...
    void DrawInfo()
    {
        ...
        GUILayout.Space(size.x);
        GUILayout.Space(size.x);
        GUILayout.Label("Screen Width " + screenRect.width, nonStyle, GUILayout.Height(size.y));
        GUILayout.Space(size.x);
        GUILayout.Label("Screen Height " + screenRect.height, nonStyle, GUILayout.Height(size.y));
        GUILayout.FlexibleSpace();
        GUILayout.EndHorizontal();
        ...
        GUILayout.Space(size.x);
        GUILayout.Label(
            "Mem Usage Of Logs " + logsMemUsage.ToString("0.000") + " mb",
            nonStyle,
            GUILayout.Height(size.y)
        );
        GUILayout.Space(size.x);
        ...
        //GUILayout.Space( size.x);
        GUILayout.Label(
            "GC Memory " + gcTotalMemory.ToString("0.000") + " mb",
            nonStyle,
            GUILayout.Height(size.y)
        );
        GUILayout.FlexibleSpace();
        ...
        GUILayout.Space(size.x);
        GUILayout.Label(
            Time.realtimeSinceStartup.ToString("000"),
            nonStyle,
            GUILayout.Height(size.y)
        );
        GUILayout.FlexibleSpace();
        ...
        GUILayout.Space(size.x);
        float _size = GUILayout.HorizontalSlider(
            size.x,
            16,
            64,
            sliderBackStyle,
            sliderThumbStyle,
            GUILayout.Width(screenRect.width * 0.5f)
        );
        if (size.x != _size)
        {
            size.x = size.y = _size;
    ...
    void drawInfo_enableDisableToolBarButtons()
    {
        ...
        if (
            GUILayout.Button(
                ...
                (showClearOnNewSceneLoadedButton) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
        ...
        if (
            GUILayout.Button(
                showTimeContent,
                (showTimeButton) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
        ...
        if (
            GUILayout.Button(
                showSceneContent,
                (showSceneButton) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
        ...
        if (
            GUILayout.Button(
                showMemoryContent,
                (showMemButton) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
        ...
        if (
            GUILayout.Button(
                showFpsContent,
                (showFpsButton) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
        ...
        if (
            GUILayout.Button(
                searchContent,
                (showSearchText) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
        ...
        if (
            GUILayout.Button(
                copyContent,
                (showCopyButton) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
        ...
        if (
            GUILayout.Button(
                saveLogsContent,
                (showSaveButton) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
    ...
    void DrawReport()
    {
        ...
        screenRect = safeArea;
        // Safe Area의 top 값을 가져옵니다.
        float safeAreaTop = safeArea.y + safeArea.height;

        Debug.Log("Safe Area Top: " + safeAreaTop);
        // screenRect.x = safeArea.x;
        // screenRect.y = safeArea.y;
        // screenRect.width = safeArea.width;
        // screenRect.height = safeArea.height;
        GUILayout.BeginArea(screenRect, backStyle);
    ...
    void drawToolBar()
    {
        toolBarRect.x = 0f;
        toolBarRect.y = top;
        toolBarRect.width = screenRect.width;
        ...
        if (
            ...
            && (downPos.y > screenRect.height - size.y * 2f)
        )
        {
        ...
        if (
            GUILayout.Button(
                collapseContent,
                (collapse) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
        ...
        if (
            ...
            && GUILayout.Button(
                clearOnNewSceneContent,
                (clearOnNewSceneLoaded) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
        ...
        if (
            ...
            && GUILayout.Button(
                showTimeContent,
                (showTime) ? buttonActiveStyle : barStyle,
                GUILayout.Width(size.x * 2),
                GUILayout.Height(size.y * 2)
            )
        )
        ...
        if (showSceneButton)
        {
            ...
            if (
                GUILayout.Button(
                    showSceneContent,
                    (showScene) ? buttonActiveStyle : barStyle,
                    GUILayout.Width(size.x * 2),
                    GUILayout.Height(size.y * 2)
                )
            )
        ...
        if (showMemButton)
        {
            if (
                GUILayout.Button(
                    showMemoryContent,
                    (showMemory) ? buttonActiveStyle : barStyle,
                    GUILayout.Width(size.x * 2),
                    GUILayout.Height(size.y * 2)
                )
            )
        ...
        if (showFpsButton)
        {
            if (
                GUILayout.Button(
                    showFpsContent,
                    (showFps) ? buttonActiveStyle : barStyle,
                    GUILayout.Width(size.x * 2),
                    GUILayout.Height(size.y * 2)
                )
            )
    ...
    void DrawLogs()
    {
        ...
        if (drag.y != 0 && logsRect.Contains(new Vector2(downPos.x, screenRect.height - downPos.y)))
        {
        ...
        int totalVisibleCount = (int)(screenRect.height * 0.75f / size.y);
        ...
        for (int i = startIndex; (startIndex + index) < endIndex; i++)
        {
            ...
            countRect.x = screenRect.width - w;
            ...
            if (log == selectedLog)
            {
                ...
                if (showMemory)
                {
                    ...
                    GUI.Label(
                        memoryLabelRect,
                        sample.memory.ToString("0.000") + " mb",
                        currentLogStyle
                    );
                }
                if (showFps)
        ...
        buttomRect.x = 0f;
        buttomRect.y = screenRect.height - size.y + top;
        buttomRect.width = screenRect.width;
    ...
    {
        graphRect = stackRect;
        graphRect.height = screenRect.height * 0.25f; //- size.y ;

        //startFrame = samples.Count - (int)(screenRect.width / graphSize) ;
        //if( startFrame < 0 ) startFrame = 0 ;
        GUI.skin = graphScrollerSkin;

        Vector2 drag = getDrag();
        if (graphRect.Contains(new Vector2(downPos.x, screenRect.height - downPos.y)))
        {
            if (drag.x != 0)
            {
        ...
        if (graphScrollerPos.x >= (samples.Count * graphSize - screenRect.width))
        ...
        for (int i = 0; i < screenRect.width / graphSize; i++)
        {
    ...
    void drawStack()
    {
        if (selectedLog != null)
        {
            ...
            if (
                drag.y != 0
                && stackRect.Contains(new Vector2(downPos.x, screenRect.height - downPos.y))
            )
            {
    ...
    public void OnGUIDraw()
    {
        ...
        top = Screen.height - screenRect.yMax;
        ...
        logsRect.x = 0f;
        logsRect.y = size.y * 2f + top;
        logsRect.width = screenRect.width;
        logsRect.height = screenRect.height * 0.75f - size.y * 2f;

        stackRectTopLeft.x = 0f;
        stackRect.x = 0f;
        stackRectTopLeft.y = screenRect.height * 0.75f + top;
        stackRect.y = screenRect.height * 0.75f + top;
        stackRect.width = screenRect.width;
        stackRect.height = screenRect.height * 0.25f - size.y + top;

        detailRect.x = 0f;
        detailRect.y = screenRect.height - size.y * 3 + top;
        detailRect.width = screenRect.width;
    ...
    bool isGestureDone()
    {
        ...
        int gestureBase = ((int)screenRect.width + (int)screenRect.height) / 4;
    ...
    void Update()
    {
        ...
        if (
            ...
            && string.IsNullOrEmpty(scenes[sceneIndex])
        )
        ...
        if (!collapse || isNew)
        {
            ...
            if (!skip)
            {
                if (
                    ...
                    || log.condition.ToLower().Contains(filterText.ToLower())
                )
                {
                    currentLog.Add(log);
                    newLogAdded = true;
    ...
    void OnApplicationQuit()
    {
        ...
        PlayerPrefs.SetInt(
            "Reporter_clearOnNewSceneLoaded",
            (clearOnNewSceneLoaded == true) ? 1 : 0
        );
        ...
        PlayerPrefs.SetInt(
            "Reporter_showClearOnNewSceneLoadedButton",
